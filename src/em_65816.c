...
static InstrType instr_table_65c816[] = {
   ...
   /* 5B */   { "TCD",  0, IMP   , 2, 0, OTHER,    op_TCD},
   /* 5C */   { "JML",  0, ABL   , 4, 0, OTHER,    0},
   ...
   /* FB */   { "XCE",  0, IMP   , 2, 0, OTHER,    op_XCE},
   /* FC */   { "JSR",  0, IND1X , 8, 0, OTHER,    op_JSR},
