...
static InstrType instr_table_scmp[] = {
   ...
   /* E0 */   { "XOR  ", 0, PCREL, 18,    READOP, op_XOR },
   ...
   /* E8 */   { "DAD  ", 0, PCREL, 23,    READOP, op_DAD },
   ...
   /* F0 */   { "ADD  ", 0, PCREL, 19,    READOP, op_ADD },
   ...
   /* F8 */   { "CAD  ", 0, PCREL, 20,    READOP, op_CAD },
